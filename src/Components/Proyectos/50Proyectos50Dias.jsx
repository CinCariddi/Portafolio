...
import inicio from '../../Imagenes/50-proyectos-inicio.jpeg'
import contraseña from '../../Imagenes/50Project50days/50-proyectos-contraseña.jpeg'
import reloj from '../../Imagenes/50Project50days/50-proyectos-reloj.jpeg'
import telefono from '../../Imagenes/50Project50days/50-proyectos-TELEFONO.jpeg'

export default function Projects50Days() {
    return (
